  ...
  return (
    <div className='nav_container'>
        ...
        <div className='nav_list'>
            ...
            <div>
                <a href="https://github.com/AmanGupt2020" target='_blank' style={{color:'inherit'}}><AiFillGithub size="3rem"/></a>
                <a href="https://www.linkedin.com/in/aman-gupta-0798a3229/" target='_blank' style={{color:'inherit'}}><AiFillLinkedin size="3rem"/></a>
            </div>
        </div>
    </div>
  )
